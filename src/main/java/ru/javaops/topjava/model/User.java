...
public class User extends BaseEntity implements HasEmail {
    ...
    @JoinTable(name = "user_vote",
            ...
            inverseJoinColumns=@JoinColumn(name="lunch_menu_id"))
    ...
    public List<Menu> getVotes() {
        return votes;
    }

    public void setVotes(List<Menu> votes) {
        this.votes = votes;
    }
