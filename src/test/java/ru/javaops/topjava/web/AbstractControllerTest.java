...
*/
        ...
        public RequestWrapper jsonUserWithPassword(UserTo userTo) {
            builder.contentType(MediaType.APPLICATION_JSON).content(JsonUtil.writeAdditionProps(userTo, "password", userTo.getPassword()));
            return this;
        }
